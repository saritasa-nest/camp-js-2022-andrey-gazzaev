...
export type PutAnimeDto = Omit<AnimeEditorDto, | 'genres_data' | 'studios_data' | 'created' | 'modified'> ;
export type PostAnimeDto = Omit<AnimeEditorDto, 'id' | 'genres_data' | 'studios_data' | 'created' | 'modified'> ;
